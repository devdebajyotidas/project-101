...
@section('page')
    ...
    <div class="page">
        ...
        <div class="page-content container-fluid">
            <div class="row" id="customer-container">
                {!! isset($customers) ? $customers : 'No result found' !!}
            </div>
    ...
    <input type="hidden" id="total_customer" value="0">
    <input type="hidden" id="total_customer" value="0">
    <script>
        window.onload=function(){
            ...
            function showMoreButton(){
                var total=$('#total_customer').val();
                var offset=$('.page').find('.customer-col').length;
